      ...
      <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Button
            variant="outlined"
            size="sm"
            className="flex items-center gap-2 border-white/50 text-white hover:bg-white/10 normal-case"
          ...
          <Button
            ...
            className="border-white/50 text-white hover:bg-white/10 normal-case"
          >
