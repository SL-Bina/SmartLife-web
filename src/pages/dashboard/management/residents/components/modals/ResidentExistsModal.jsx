...
import {
  ExclamationTriangleIcon, LinkIcon, UserPlusIcon, XMarkIcon,
} from "@heroicons/react/24/outline";

/**
 * Shown when the API returns 426 — a resident with the same data already exists.
 * The user chooses how to proceed:
 *   - bind_existing: true  → link the existing resident to the chosen property
 *   - bind_existing: false → create a brand-new resident with the same data
 */
    ...
    >
      <DialogHeader className="border-b border-amber-200 dark:border-amber-700 pb-4 flex items-center justify-between bg-amber-50 dark:bg-amber-900/30 rounded-t-xl">
        <div className="flex items-center gap-3">
          ...
          <Typography variant="h6" className="text-amber-800 dark:text-amber-300 font-bold">
            Sakin artıq mövcuddur
          </Typography>
        </div>
        <Button
          variant="text"
          size="sm"
          onClick={onClose}
          className="text-amber-700 hover:bg-amber-100 dark:text-amber-400 dark:hover:bg-amber-800/40 rounded-full p-2"
        >
      ...
      <DialogBody className="p-6">
        <Typography className="text-gray-700 dark:text-gray-300 mb-6 text-sm leading-relaxed">
          Bu məlumatlarla uyğun sakin artıq sistemdə mövcuddur.
          Necə davam etmək istəyirsiniz?
        </Typography>
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            ...
            <div>
              <Typography variant="small" className="font-bold text-blue-800 dark:text-blue-300 mb-0.5">
                Mövcud sakini mənzilə bağla
              </Typography>
              <Typography variant="small" className="text-blue-600 dark:text-blue-400">
                Sistemdəki sakin qeyd etdiyiniz mənzilə əlavə ediləcək
              </Typography>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <Typography variant="small" className="font-bold text-green-800 dark:text-green-300 mb-0.5">
                Yeni sakin kimi əlavə et
              </Typography>
              <Typography variant="small" className="text-green-600 dark:text-green-400">
                Eyni məlumatlarla tamamilə yeni sakin yaradılacaq
              </Typography>
            </div>
          </button>
        </div>
      ...
      <DialogFooter className="border-t border-gray-200 dark:border-gray-700 pt-4">
        <Button
          ...
          onClick={onClose}
          disabled={saving}
          className="border-gray-500 text-gray-600 hover:bg-gray-100 dark:border-gray-500 dark:text-gray-400 dark:hover:bg-gray-700 w-full"
        >
