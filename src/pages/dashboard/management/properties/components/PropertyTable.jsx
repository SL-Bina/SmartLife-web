...
import { EllipsisVerticalIcon, ChevronUpIcon, ChevronDownIcon, PencilIcon, TrashIcon, CurrencyDollarIcon, EyeIcon, BanknotesIcon } from "@heroicons/react/24/outline";

export function PropertyTable({ items = [], loading, onView, onEdit, onDelete, onServiceFee, onAddBalance, onSelect, selectedPropertyId }) {
